...
// Koordinat texture itu bayangkan kalau kita liat dari dalam object?
...
int main()
{
	...
	// Generates Vertex Array Objects and binds it
	VAO lightVAO;
	lightVAO.Bind();
	// Generates Vertex Buffer Object and links it to vertices
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Export the camMatrix to the Vertex Sahder of the pyramid
