...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(width, height, "Stencil Buffer", NULL, NULL);
	...
	// Load in a model
	Model model("../Models/crow/scene.gltf"); // not used at the end
